...
<ul>
    ...
    <li>Exemple avec les sessions : voici les pages de navigation session_page1.php et session_page2.php. Et voici la page de login session_login.php et de logout session_logout.php</li>
    <li>Exemple avec les cookies : </li>
    <li>Exemple de gestion des fichiers :</li>
    <li>TP 2 : </li>
